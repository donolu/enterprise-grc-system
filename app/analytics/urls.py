...
urlpatterns = [
    ...
    path(
        "policy-management/", views.policy_management_dashboard, name="policy_management_dashboard"
    ),
    path(
        "training-effectiveness/",
        views.training_effectiveness_dashboard,
        name="training_effectiveness_dashboard",
    ),
