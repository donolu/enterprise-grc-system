...
class OperatorProductAnalyticsTest(TestCase):
    def setUp(self):
        ...
        with schema_context("public"):
            ...
            self.tenant_a = self._create_tenant(
                "tenant_a_analytics", "tenant-a-analytics", "Tenant A"
            )
            self.tenant_b = self._create_tenant(
                "tenant_b_analytics", "tenant-b-analytics", "Tenant B"
            )
    ...
    def test_operator_dashboard_aggregates_usage_without_tenant_content(self):
        ...
        module_counts = {
            module["module_key"]: module["tenant_count"] for module in dashboard["module_adoption"]
        }
