...
class TOTPService:
    ...
    @staticmethod
    def create_provisioning_uri(secret: str, user_email: str, issuer_name: str = None) -> str:
        """
    ...
    @staticmethod
    def setup_totp_device(user: User, password: str, device_name: str = None) -> Dict[str, any]:
        """
        ...
        device = TOTPDevice.objects.create(
            user=user, name=device_name or f"Authenticator App - {user.username}", confirmed=False
        )
    ...
    @staticmethod
    def confirm_totp_setup(user: User, token: str) -> Tuple[bool, TOTPDevice | None]:
        """
