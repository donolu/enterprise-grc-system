# Generated by Django 5.0.6 on 2025-08-22 00:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.CharField(choices=[('free', 'Free'), ('basic', 'Basic'), ('ent', 'Enterprise')], default='free', max_length=10)),
                ('seats', models.PositiveIntegerField(default=5)),
                ('trial_item', models.CharField(blank=True, max_length=40, null=True)),
