...
If you have questions about this rejection, please contact the approver team.
            ...
            logger.info(
                f"Override request {override_request.id} was rejected: {override_request.rejection_reason}"
            )
    ...
    def send_application_notification(override_request):
        ...
        try:
            ...
            subject = (
                f"APPLIED - {override_request.subscription.tenant.name} Override is Now Active"
            )
