...
MODULE_CATALOG = [
    ...
    ModuleDefinition(
        "risk", "Risk Management", "Risk register, treatment plans and action tracking"
    ),
    ModuleDefinition(
        "vendors", "Third-Party Management", "Vendor inventory, reviews, tasks and follow-up dates"
    ),
    ModuleDefinition(
        "policies", "Policies", "Policy, standard and procedure library and acknowledgements"
    ),
    ModuleDefinition("training", "Training", "Security awareness campaigns and training material"),
    ModuleDefinition(
        "assets", "Asset Management", "Information asset register and ownership reviews"
    ),
    ...
    ModuleDefinition(
        ...
        "Scanner integration and vulnerability reporting",
    ),
]
