...
def test_analytics_service_structure():
    ...
    for method in analytics_methods:
        assert hasattr(RiskAnalyticsService, method), (
            f"RiskAnalyticsService missing method: {method}"
        )

    # Test that report generator has required methods
    report_methods = ["generate_risk_dashboard_data", "get_risk_category_deep_dive"]
...
def test_admin_dashboard_integration():
    ...
    required_methods = ["get_admin_dashboard_data", "admin_dashboard_html"]

    for method in required_methods:
        assert hasattr(RiskAnalyticsDashboard, method), (
            f"RiskAnalyticsDashboard missing method: {method}"
        )
