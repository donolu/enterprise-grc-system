...
class GRCDataGenerator:
    ...
    def create_risk_data(self):
        ...
        risk_cats_data = [
            {
                "name": "Cybersecurity",
                "description": "Information security and cyber threats",
                "color": "#dc2626",
            },
            {
                "name": "Operational",
            ...
            {
                "name": "Regulatory",
                "description": "Compliance and regulatory risks",
                "color": "#7c2d12",
            },
            {
                "name": "Strategic",
                "description": "Strategic and reputational risks",
                "color": "#7c3aed",
            },
        ]
        ...
        risks_data = [
            ...
            },
            {
                ...
                "description": "Risk of business disruption and data loss due to ransomware attacks.",
                "category": 0,
                "impact": 5,
                "likelihood": 2,
                "status": "identified",
            ...
            },
            {
                ...
                "description": "Risk of penalties due to failure to comply with GDPR, SOX regulations.",
                "category": 3,
                "impact": 4,
                "likelihood": 2,
                "status": "under_review",
            ...
            },
            {
                ...
                "description": "Risk of operational disruption due to critical supplier failure.",
                "category": 1,
                "impact": 3,
                "likelihood": 3,
                "status": "mitigating",
            ...
            },
            {
                ...
                "description": "Risk of knowledge loss due to unexpected departure of key personnel.",
                "category": 1,
                "impact": 3,
                "likelihood": 2,
                "status": "identified",
            ...
            },
            {
                ...
                "description": "Risk of revenue impact due to economic downturn and market volatility.",
                "category": 2,
                "impact": 4,
                "likelihood": 3,
                "status": "monitored",
            ...
            },
            {
                ...
                "description": "Risk of competitive disadvantage due to outdated technology stack.",
                "category": 4,
                "impact": 3,
                "likelihood": 4,
                "status": "identified",
            ...
            },
            {
                ...
                "description": "Risk of privacy violations and regulatory penalties.",
                "category": 3,
                "impact": 4,
                "likelihood": 2,
                "status": "assessed",
            ...
            },
            {
                ...
                "description": "Risk of unauthorised physical access to facilities.",
                "category": 0,
                "impact": 2,
                "likelihood": 2,
                "status": "mitigated",
    ...
    def create_vendor_data(self):
        ...
        vendor_cats_data = [
            {
                "name": "Cloud Services",
                "description": "Cloud infrastructure and SaaS providers",
                "color_code": "#3b82f6",
                "risk_weight": "high",
            },
            {
                "name": "Professional Services",
                "description": "Consulting and professional service providers",
                "color_code": "#10b981",
                "risk_weight": "medium",
            },
            {
                "name": "Technology Vendors",
                "description": "Software and hardware technology providers",
                "color_code": "#f59e0b",
                "risk_weight": "medium",
            },
            {
                "name": "Financial Services",
                "description": "Banking, payment, and financial service providers",
                "color_code": "#ef4444",
                "risk_weight": "high",
            },
        ]
        ...
        vendors_data = [
            ...
            },
            {
                ...
                "vendor_type": "service_provider",
                "risk_level": "medium",
                "annual_spend": 240000.00,
                "contact": {
                    "first_name": "Sarah",
                    "last_name": "Johnson",
                    "email": "sarah.j@aws.amazon.com",
            ...
            },
            {
                ...
                "vendor_type": "service_provider",
                "risk_level": "medium",
                "annual_spend": 45000.00,
                "contact": {
                    "first_name": "Jennifer",
                    "last_name": "Wilson",
                    "email": "jwilson@okta.com",
            ...
            },
            {
                ...
                "vendor_type": "service_provider",
                "risk_level": "low",
                "annual_spend": 72000.00,
                "contact": {
                    "first_name": "David",
                    "last_name": "Brown",
                    "email": "dbrown@crowdstrike.com",
            ...
            },
            {
                ...
                "vendor_type": "service_provider",
                "risk_level": "low",
                "annual_spend": 24000.00,
                "contact": {
                    "first_name": "Lisa",
                    "last_name": "Garcia",
                    "email": "lgarcia@jpmorgan.com",
            ...
            },
            {
                ...
                "vendor_type": "service_provider",
                "risk_level": "medium",
                "annual_spend": 36000.00,
                "contact": {
                    "first_name": "Robert",
                    "last_name": "Martinez",
                    "email": "rmartinez@atlassian.com",
    ...
    def create_policy_data(self):
        ...
        policy_cats_data = [
            ...
            {
                "name": "Operations",
                "description": "Business operations and procedures",
                "color": "#ea580c",
            },
        ]
        ...
        policies_data = [
            {
                ...
                "status": "approved",
                "version": "2.1",
                "summary": "Updated encryption requirements",
            },
            {
                ...
                "status": "approved",
                "version": "1.3",
                "summary": "Added cloud storage guidelines",
            },
            {
                ...
                "status": "approved",
                "version": "1.5",
                "summary": "Updated VPN requirements",
            },
            {
                ...
                "status": "approved",
                "version": "3.0",
                "summary": "Major update to escalation procedures",
            },
            {
                ...
                "status": "approved",
                "version": "1.2",
                "summary": "Enhanced risk evaluation criteria",
            },
            {
                ...
                "status": "under_review",
                "version": "2.0",
                "summary": "Streamlined onboarding process",
            },
            {
                ...
                "status": "approved",
                "version": "1.8",
                "summary": "Updated recovery objectives",
            },
            {
                ...
                "status": "approved",
                "version": "4.0",
                "summary": "Annual review with updated ethics guidelines",
            },
        ]
    ...
    def create_training_data(self):
        ...
        videos_data = [
            ...
            },
            {
                ...
                "description": "Create strong passwords and use multi-factor authentication.",
                "category": 0,
                "difficulty": "beginner",
                "duration": 18,
            ...
            },
            {
                ...
                "description": "Understand how to properly classify sensitive data.",
                "category": 2,
                "difficulty": "intermediate",
                "duration": 28,
    ...
    def create_framework_data(self):
        ...
        frameworks_data = [
            ...
            },
            {
                ...
                "status": "active",
                "mandatory": True,
                "clauses": [{"id": "Art.32", "title": "Security of processing", "type": "control"}],
            },
        ]
