...
def test_risk_analytics_template_exists():
    ...
    template_path = os.path.join(
        settings.BASE_DIR, "exports", "templates", "exports", "reports", "risk_analytics.html"
    )
...
def test_assessment_summary_template_integration():
    ...
    # Build template path
    template_path = os.path.join(
        settings.BASE_DIR, "exports", "templates", "exports", "reports", "assessment_summary.html"
    )
    ...
    for element in integration_elements:
        assert element in template_content, (
            f"Assessment summary missing risk integration: {element}"
        )
