...
class AssessmentReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Report Information", {"fields": ["title", "description", "report_type", "framework"]}),
        (
    ...
    actions = ["generate_selected_reports", "mark_as_failed", "reset_to_pending"]
    ...
    def reset_to_pending(self, request, queryset):
        ...
        self.message_user(request, f"{updated} report(s) reset to pending status")
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj and obj.status == "processing":
            ...
            readonly.extend(["report_type", "framework", "title"])
        ...
        if "_generate" in request.POST:
            if obj.status == "processing":
                ...
                try:
                    ...
                    self.message_user(
                        request, f"Failed to start generation: {str(e)}", messages.ERROR
                    )
    ...
    def change_view(self, request, object_id, form_url="", extra_context=None):
        ...
        try:
            ...
            if obj:
                extra_context["show_generate_button"] = obj.status in [
                    "pending",
                    "failed",
                    "completed",
                ]
