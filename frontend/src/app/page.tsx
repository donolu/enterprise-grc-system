    ...
    <div className="dashboard-page">
      ...
      <section className="dashboard-grid dashboard-grid-main">
        ...
        <article className="surface-panel posture-panel">
          ...
          <div className="posture-score"><Progress aria-label="Overall compliance" type="circle" percent={numbers.compliance} size={142} strokeColor="#0b8f84" railColor="#e5efed" format={(value) => <><strong>{value}%</strong><small>overall</small></>} /><div className="posture-copy"><CheckCircleFilled /> <span>On track for this period</span><p>Keep the review queue moving to protect the current posture.</p></div></div>
      ...
      <section className="dashboard-footer-strip"><div><span className="footer-icon"><SafetyCertificateOutlined /></span><span><strong>Keep the programme moving</strong><small>Review open work and keep each control decision owned.</small></span></div><Space><Button href="/assessments" icon={<CalendarOutlined />}>Open assessment setup</Button><Button type="primary" href="/admin" icon={<PlusOutlined />}>Import a framework</Button></Space></section>
    </div>
  );
}
